"""Loaders for the friendship data.

The small and medium graphs are committed under ../data. The large and dense
...
seeds. The same seed always produces the same graph.
    ...
    get_dense_graph()     8000 users, about 150 friends each

Each get_*_queries() returns the users to produce recommendations for.
"""
...
def get_dense_graph():
    return _cached("dense", lambda: SocialGraph(_build_pairs(8000, 150, seed=70003)))


def get_dense_queries():
    return _queries(8000, 400, seed=70004)
